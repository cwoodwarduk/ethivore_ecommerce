...
const detailsForProduct = (productId) => async (dispatch) => {
    try{
...
const saveProductReview = (productId, review) => async (dispatch, getState) => {
    try {
        ...
        console.log("prior to save request");
...
export {listProducts, detailsForProduct, saveProduct, deleteProduct, saveProductReview}